 ...
 */
export const request = (_a) => __awaiter(void 0, [_a], void 0, function* ({ method, url, payload, params, headers, host, timeout, auth, maxBodyLength, }) {
    const options = {
        method,
    ...
    if (!Helper.isEmpty(maxBodyLength)) {
